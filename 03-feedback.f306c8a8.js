...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l=document.querySelector('[name="message"]'),o=document.querySelector('[name="email"]'),n="feedback-form-state";function r(){const e={message:l.value,email:o.value};localStorage.setItem(n,JSON.stringify(e)),console.log("throttle")}function s(){const e=localStorage.getItem(n);if(e){const t=JSON.parse(e);l.value=t.message,o.value=t.email}}s(),a.addEventListener("input",(0,e.default)(r,500)),a.addEventListener("submit",e=>{e.preventDefault();const t=JSON.parse(localStorage.getItem(n));null===t||0===t.message.length||0===t.email.length?alert("Все поля должны быть заполнены!"):(localStorage.removeItem(n),a.reset(),console.log(t))});
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f306c8a8.js.map