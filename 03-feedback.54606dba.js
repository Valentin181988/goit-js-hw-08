...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector(".feedback-form"),a=document.querySelector('[name="message"]'),l=document.querySelector('[name="email"]'),r="feedback-form-state";function n(){const e={message:a.value,email:l.value};localStorage.setItem(r,JSON.stringify(e)),console.log("throttle")}function s(){const e=localStorage.getItem(r);if(e){const t=JSON.parse(e);a.value=t.message,l.value=t.email}}s(),o.addEventListener("input",(0,e.default)(n,500)),o.addEventListener("submit",e=>{e.preventDefault();const t=JSON.parse(localStorage.getItem(r));null==t?alert("Все поля должны быть заполнены!"):(localStorage.removeItem(r),o.reset(),console.log(t))});
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.54606dba.js.map